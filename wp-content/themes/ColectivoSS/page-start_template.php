<?php
	/*
	Template Name: Start without sidebar
	*/
?>
		...
		<div class="container-fluid photolith">
			<div class="row">
				...
				<div class="col-xs-12 col-md-6 text-center photo-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/photolith/m-papeld.png" alt="Papel Diamante" class="img-responsive text">
					<p><strong>Papel Diamante</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center photo-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/photolith/m-sharpie.png" alt="Sharpies y tiralíneas negros" class="img-responsive">
					<p><strong>Sharpies negros</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center photo-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/photolith/m-masking.png" alt="Masking Tape" class="img-responsive">
					<p><strong>Masking Tape</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center photo-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/photolith/m-hoja.png" alt="Hoja Impresa con el diseño" class="img-responsive">
					<p><strong>Hoja con el diseño</strong></p>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12">
		...
		<div class="container-fluid frame">
			<div class="row">
				...
				<div class="col-xs-12 col-md-6 text-center frame-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/frame/m-madera.png" alt="Listones de Pino Cepillado" class="img-responsive text">
					<p><strong>Pino Cepillado (2x1 in.)</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center frame-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/frame/m-engrapa.png" alt="Engrapadora y Grapas" class="img-responsive">
					<p><strong>Engrapadora</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center frame-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/frame/m-clavosmar.png" alt="Martillos y Clavos" class="img-responsive">
					<p><strong>Martillos y Clavos</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center frame-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/frame/m-velo.png" alt="Velo Italiano o Muselina" class="img-responsive text">
					<p><strong>Velo Italiano (Muselina)</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 col-md-offset-3 text-center frame-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/frame/m-amigo.png" alt="Un Amigo" class="img-responsive">
		...
		<div class="container-fluid developing">
			<div class="row">
				...
				<div class="col-xs-12 col-md-6 text-center developing-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/developing/m-lava.png" alt="Lavaloza" class="img-responsive text">
					<p><strong>Lavaloza</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center developing-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/developing/m-esponja.png" alt="Esponja de Cocina" class="img-responsive">
					<p><strong>Esponja de Cocina</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center developing-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/developing/m-bastidor.png" alt="Bastidor Listo y Tensado" class="img-responsive">
					<p><strong>Bastidor Tensado</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center developing-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/developing/m-manguera.png" alt="Manguera" class="img-responsive">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-6 text-center developing-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/developing/m-mesaluz.png" alt="Mesa de Luz" class="img-responsive">
					<p><strong>Mesa de Luz</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center developing-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/developing/m-emulsion.png" alt="Emulsión Fotosensible (Ulano 925)" class="img-responsive">
					<p><strong>Emulsión Fotosensible (Ulano 925)</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center developing-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/developing/m-espatula.png" alt="Racleta, Squeegee o Espátula Plástica" class="img-responsive">
					<p><strong>Racleta o Espátula Plástica</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center developing-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/developing/m-fotolito.png" alt="Fotolito listo" class="img-responsive">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-6 text-center developing-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/developing/m-pesos.png" alt="Cosas para hacer peso" class="img-responsive">
					<p><strong>Cosas para hacer peso</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center developing-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/developing/m-secador.png" alt="Secador de Pelo" class="img-responsive">
		...
		<div class="container-fluid print">
			<div class="row">
				...
				<div class="col-xs-12 col-md-6 text-center print-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/print/m-polera.png" alt="Tela a imprimir" class="img-responsive text">
					<p><strong>Tela Algodón > 80%</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center print-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/print/m-mesa.png" alt="Mesa o Base Sólida" class="img-responsive">
					<p><strong>Mesa o Base Sólida</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center print-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/print/m-carton.png" alt="Cartón Piedra o Trozo de Madera" class="img-responsive">
					<p><strong>Cartón Piedra</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center print-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/print/m-tinta.png" alt="Tinta al Agua, color a elección" class="img-responsive text">
					<p><strong>Tinta al Agua</strong></p>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-12">
				...
				<div class="col-xs-12 col-md-6 text-center print-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/print/m-espatula.png" alt="Racleta o Espátula de plástico" class="img-responsive text">
					<p><strong>Espátula de plástico</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center print-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/print/m-manguera.png" alt="Manguera y Agua" class="img-responsive">
					<p><strong>Manguera y Agua</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center print-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/print/m-bastidorlisto.png" alt="Bastidor Listo" class="img-responsive">
					<p><strong>Bastidor Listo</strong></p>
				</div>
				<div class="col-xs-12 col-md-6 text-center print-item">
					<img src="<?php bloginfo("template_url"); ?>/assets/img/print/m-esponja.png" alt="Esponja de Cocina" class="img-responsive">
					<p><strong>Esponja de Cocina</strong></p>
				</div>
			</div>
			<div class="row">
